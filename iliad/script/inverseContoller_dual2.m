...
box_D = inv(toUR10etf)*boxtf_01*[[eul2rotm([0,0,0],'ZYX')],[dimBox(1)/2,-dimBox(2)/2,-dimBox(3)/2]'; ...
                                            0 0 0                        1           ];
plot3(box_A(1,4),box_A(2,4),box_A(3,4),'.','Color','r','MarkerSize',50)
...
boxPos_offset = [0;+dimBox(2)/2-0.03;-dimBox(3)/2-0.05];
...
boxPose2 = boxtf_01*[[eul2rotm([pi+pi/2,-pi/2-pi/16,0],'ZYX')],[boxPos_offset(1);boxPos_offset(2);boxPos_offset(3)]; ...
                                0 0 0                               1           ];
