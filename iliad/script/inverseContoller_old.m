...
boxPos_offset = [0;-dimBox(2)/2-velvet_length;-velvet_height/2-dimBox(3)/2];
...
boxPose2 = boxtf_01*[[eul2rotm([pi+pi/2,0,0],'ZYX')],[boxPos_offset(1);boxPos_offset(2);boxPos_offset(3)]; ...
                                0 0 0                               1           ];
...
tform = [[eul2rotm([0 0 0], 'xyz')],[0.20,0,0.04]'; ...
                      0 0 0                     1   ];
setFixedTransform(jnt,tform);
...
tform = [[eul2rotm([0 0 0], 'xyz')],[0.28,0,0.04]'; ...
                      0 0 0                     1   ];
setFixedTransform(jnt,tform);
